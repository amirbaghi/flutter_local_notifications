...
=======
>>>>>>> [flutter_local_notifications] fix code around calling iOS completion handlers (#652)
=======
* Bumped lower bound of Dart SDK dependency to 2.0
>>>>>>> [flutter_local_notifications] bumped lower bound of Dart SDK dependency to 2.0 (#653)
